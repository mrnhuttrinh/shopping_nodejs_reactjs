...
export default class Filter extends Component {
    ...
    _onSearch(event) {
        ...
        var endDate = moment(this.state.endDate).add(1, "day");
    ...
    _onCreateOrder(event) {
        event.preventDefault();
        this.props.createOrderFrom(true);
    }
    render() {
        return (
            <div className="jarviswidget" id="wid-id-3" data-widget-editbutton="false" data-widget-custombutton="false">
                <header>
                    ...
                    <h2>Đơn Đặt Hàng</h2>
                    <a onClick={this._onCreateOrder.bind(this)} className="pull-right btn btn-success btn-sm">Tạo Đơn Đặt Hàng Mới</a>
                </header>
                <div>
                                ...
                                <div className="row">
                                    ...
                                    <section className="col col-4">
                                        <label className="input"> 
                                            ...
                                            <input type="text" ref="CustomerName" name="CustomerName" placeholder="Tên Khách Hàng/Số Điện Thoại" />
                                        </label>
                                    </section>
                                    <section className="col col-4">
