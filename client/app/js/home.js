...
var homePage = function() {
    function u(u) {
        !n && t <= u && u <= i ? (r.addClass("H_cate_fixed"),
        n = !0) : n && (u < t || i < u) && (r.removeClass("H_cate_fixed"),
        n = !1)
    }
    ...
    return {
        ...
        LoadVoucherData: function(n) {
            shellService.ExecuteGetAction("Home/GetVoucherFloor", {
                voucherCityId: n
            }).then(function(n) {
        ...
        InitFloorJumping: function() {
            var r = $("#floorjumping"), n;
            r.length && (t = r.offset().top - 140);
            n = $(".cont_pre_bottom");
            n.length && (i = n.offset().top - 400)
        },
        ...
        UpdateNormalFloor: function(n, t) {
            var i = $('[data-floor="' + n + '"]')
              , r = $(i).attr("data-cat-id");
            shellService.ExecuteGetAction("Home/GetProductNormalFloor", {
                categoryId: r,
                floorIndex: n,
                voucherCityId: t
            }).then(function(n) {
                i.find("ul.listdeal_four").html(n.html)
            }).fail(function() {
                common.Alert("Có lỗi xảy ra, vui lòng thử lại.")
            })
        }
  ...
  , flashsale = function() {
    ...
    return {
        ...
        GetProductList: function() {
            return shellService.ExecuteGetAction("Home/LoadMoreFlashSale", {
                pageIndex: ++t,
                pageSize: n,
                sortType: i
            })
