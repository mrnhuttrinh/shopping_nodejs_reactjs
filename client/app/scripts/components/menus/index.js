                ...
                <div className="container dad">
                    <div className="menu_cate">
                        <ul className="menu_ver">
                            <li>
                                <a href="/deal-moi" onclick="common.SendTrackingMenu('Khuyến mãi mới nhất', '/deal-moi'); return false;">
                                    <span className="ic_cm icon-new">C</span>Khuyến mãi mới nhất
                                </a>
                            </li>
                            <li>
                                <a href="/voucher" onclick="common.SendTrackingMenu('Voucher Nhóm Mua', '/voucher'); return false;">
                                    <span className=" ic_cm icon-logonm">e</span>Voucher Nhóm Mua
                                    <span className="ic_cm  icon_arr">K</span>
                                </a>
                            ...
                            <li>
                                <a href="/voucher/du-lich-khach-san" onclick="common.SendTrackingMenu('Du lịch - Khách sạn', '/voucher/du-lich-khach-san'); return false;">
                                    <span className="icon_cm icon-airplane"></span>Du lịch - Khách sạn
                                    <span className="icon_cm  icon_arr"></span>
                                </a>
                                <div className="menu_ver_hover">
                                    <ul className="menu_ver_item">
                                        <li className="bold">
                                    ...
                                    <ul className="menu_ver_item">
                                        <li className="bold1">
                                            <a href="javascript:void(0)">Điểm đến Hot</a>
                                        </li>
                                        <li>
                                            <a href="/voucher/du-lich-khach-san/phan-thiet_l28" onclick="common.SendTrackingMenu('Phan Thiết', '/voucher/du-lich-khach-san/phan-thiet_l28'); return false;">Phan Thiết</a>
                                        </li>
                                        <li>
                                            <a href="/voucher/du-lich-khach-san/vung-tau_l38" onclick="common.SendTrackingMenu('Vũng Tàu', '/voucher/du-lich-khach-san/vung-tau_l38'); return false;">Vũng Tàu</a>
                                        </li>
                                        <li>
                                            <a href="/voucher/du-lich-khach-san/da-lat_l30" onclick="common.SendTrackingMenu('Đà Lạt', '/voucher/du-lich-khach-san/da-lat_l30'); return false;">Đà Lạt</a>
                                        </li>
                                        <li>
                                            <a href="/voucher/du-lich-khach-san/nha-trang_l29" onclick="common.SendTrackingMenu('Nha Trang', '/voucher/du-lich-khach-san/nha-trang_l29'); return false;">Nha Trang</a>
                                        </li>
                                        <li>
                                            <a href="/voucher/du-lich-khach-san/da-nang_l33" onclick="common.SendTrackingMenu('Đà Nẵng', '/voucher/du-lich-khach-san/da-nang_l33'); return false;">Đà Nẵng</a>
                                        </li>
                                        <li>
                                            <a href="/voucher/du-lich-khach-san/phu-quoc_l31" onclick="common.SendTrackingMenu('Phú Quốc', '/voucher/du-lich-khach-san/phu-quoc_l31'); return false;">Phú Quốc</a>
                                        </li>
                                        <li>
                                            <a href="/voucher/du-lich-khach-san/campuchia_l496" onclick="common.SendTrackingMenu('Campuchia', '/voucher/du-lich-khach-san/campuchia_l496'); return false;">Campuchia</a>
                                        </li>
                                        <li>
                                            <a href="/voucher/du-lich-khach-san/thai-lan_l493" onclick="common.SendTrackingMenu('Thái Lan', '/voucher/du-lich-khach-san/thai-lan_l493'); return false;">Thái Lan</a>
                                        </li>
                                    </ul>
                            ...
                            <li>
                                <a href="/thoi-trang-nu" onclick="common.SendTrackingMenu('Thời trang nữ', '/thoi-trang-nu'); return false;">
                                    <span className="ic_cm">z</span>Thời trang nữ
                                    <span className="ic_cm  icon_arr">K</span>
                                </a>
                                <div className="menu_ver_hover">
                                    <ul className="menu_ver_item">
                            ...
                            <li>
                                <a href="/thoi-trang-nam" onclick="common.SendTrackingMenu('Thời trang nam', '/thoi-trang-nam'); return false;">
                                    <span className="ic_cm">y</span>Thời trang nam
                                    <span className="ic_cm  icon_arr">K</span>
                                </a>
                                <div className="menu_ver_hover">
                                    <ul className="menu_ver_item">
                            ...
                            <li>
                                <a href="/my-pham-suc-khoe" onclick="common.SendTrackingMenu('Mỹ phẩm - Sức khỏe', '/my-pham-suc-khoe'); return false;">
                                    <span className="ic_cm">q</span>Mỹ phẩm - Sức khỏe
                                    <span className="ic_cm  icon_arr">K</span>
                                </a>
                                <div className="menu_ver_hover">
                                    <ul className="menu_ver_item">
                            ...
                            <li>
                                <a href="/nha-cua-gia-dung" onclick="common.SendTrackingMenu('Nhà cửa - Gia dụng', '/nha-cua-gia-dung'); return false;">
                                    <span className="ic_cm">x</span>Nhà cửa - Gia dụng
                                    <span className="ic_cm  icon_arr">K</span>
                                </a>
                                <div className="menu_ver_hover">
                                    <ul className="menu_ver_item">
                            ...
                            <li>
                                <a href="/do-choi-be-yeu" onclick="common.SendTrackingMenu('Đồ chơi - Bé yêu', '/do-choi-be-yeu'); return false;">
                                    <span className="ic_cm">m</span>Đồ chơi - Bé yêu
                                    <span className="ic_cm  icon_arr">K</span>
                                </a>
                                <div className="menu_ver_hover">
                                    <ul className="menu_ver_item">
                            ...
                            <li>
                                <a href="/cong-nghe-phu-kien" onclick="common.SendTrackingMenu('Công nghệ - Phụ kiện', '/cong-nghe-phu-kien'); return false;">
                                    <span className="ic_cm">F</span>Công nghệ - Phụ kiện
                                    <span className="ic_cm  icon_arr">K</span>
                                </a>
                                <div className="menu_ver_hover">
                                    <ul className="menu_ver_item">
                            ...
                            <li className="end">
                                <a href="/thuc-pham-dinh-duong" onclick="common.SendTrackingMenu('Thực phẩm - Dinh dưỡng', '/thuc-pham-dinh-duong'); return false;">
                                    <span className="ic_cm">v</span>Thực phẩm - Dinh dưỡng
                                    <span className="ic_cm  icon_arr">K</span>
                                </a>
                                <div className="menu_ver_hover">
                                    <ul className="menu_ver_item">
